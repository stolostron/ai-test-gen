...
bash -n create-test-case.sh && echo "✅ Main script syntax OK"
...
[ -x create-test-case.sh ] && echo "✅ Main script executable" || echo "❌ Main script not executable"
...
if ./create-test-case.sh ACM-22079 --dry-run --test-plan-only >/dev/null 2>&1; then
